...
<div class="top-app-bar w-full px-4 fixed top-0 !max-h-[64px] !h-[64px] bg-on-primary  flex flex-row align-middle items-center">
...
<break class="block w-full h-16"></break>
<slot />